...
def search_hospital_articles_v3(hospital_name,driver=None):
    # # 设置 ChromeDriver 的路径
...
def count_hospitals_from_file(file_path,output_excel_path):
    ...
    try:
        ...
        for name in hospital_names:
            time_jiaohu,urls_with_keywords = search_hospital_articles_v3(name,driver)
            for keyword in keywords:
...
if __name__ == "__main__":
    ...
    output_excel_path = 'E:\Dasishang\GISshixi\Data\医院搜索结果.xlsx'
